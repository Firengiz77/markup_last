...
<img src='/public/<?php echo e($slider->image); ?>' width='200' class='mt-2'/>
...
<?php echo e(Form::text('title', $slider->getTranslation('title', $code), array('class' => 'form-control', 'placeholder' => __('Enter title'), 'required' => 'required'))); ?>
...
<?php echo e(Form::textarea('desc', $slider->getTranslation('desc', $code), array('class' => 'form-control', 'placeholder' => __('Enter desc'), 'required' => 'required'))); ?>
...
<div class='col-12'>
<div class='form-group'>
<?php echo e(Form::label('buttonText', __('Button text'), array('class' => 'form-label'))); ?>

<?php echo e(Form::text('buttonText', $slider->getTranslation('buttonText', $code), array('class' => 'form-control', 'placeholder' => __('Enter buttonText'), 'required' => 'required'))); ?>
...
<?php echo e(Form::text('link', $slider->link, array('class' => 'form-control', 'placeholder' => __('Enter link'), 'required' => 'required'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bcg\resources\views/slider/edit.blade.php ENDPATH**/ ?>