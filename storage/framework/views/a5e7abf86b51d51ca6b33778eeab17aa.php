...
<?php echo e(Form::textarea('question', $faq->getTranslation('question', $code), array('class' => 'form-control','placeholder' => __('Enter question'), 'required' => 'required'))); ?>
...
<?php echo e(Form::textarea('answer', $faq->getTranslation('answer', $code), array('class' => 'form-control', 'placeholder' => __('Enter answer'), 'required' => 'required'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\markup\resources\views/faq/edit.blade.php ENDPATH**/ ?>