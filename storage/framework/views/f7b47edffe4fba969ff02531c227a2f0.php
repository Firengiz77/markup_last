...
<img src='/public/<?php echo e($contact->image); ?>' width='200' class='mt-2'/>
...
<?php echo e(Form::text('address', $contact->getTranslation('address', $code), array('class' => 'form-control', 'placeholder' => __('Enter address'), 'required' => 'required'))); ?>
...
<?php echo e(Form::text('phone', $contact->phone, array('class' => 'form-control', 'placeholder' => __('Enter phone'), 'required' => 'required'))); ?>
...
<?php echo e(Form::text('email', $contact->email, array('class' => 'form-control', 'placeholder' => __('Enter email'), 'required' => 'required'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bcg\resources\views/contact/edit.blade.php ENDPATH**/ ?>