            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <?php $__currentLoopData = \App\Models\Utility::languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tab-pane fade <?php echo e($loop->first?"active show":""); ?>" id="pills-<?php echo e($code); ?>" role="tabpanel"
                        ...
                        <?php echo e(Form::model($contact, array('route' => array('contact.update', $contact->id), 'method' => 'PUT','enctype'=>'multipart/form-data'))); ?>
...
<?php echo e(Form::textarea('phone', $contact->phone, array('class' => 'form-control','rows'=> 4, 'placeholder' => __('Enter phone'), 'required' => 'required'))); ?>
...
<?php echo e(Form::textarea('email', $contact->email, array('class' => 'form-control', 'rows'=> 4,'placeholder' => __('Enter email'), 'required' => 'required'))); ?>
...
<?php echo e(Form::textarea('address', $contact->getTranslation('address', $code), array('class' => 'form-control','rows'=> 4, 'placeholder' => __('Enter address'), 'required' => 'required'))); ?>
 ...
 <div class='col-12'>
<div class='form-group'>
<?php echo e(Form::label('map', __('Map'), array('class' => 'form-label'))); ?>

<?php echo e(Form::textarea('map', $contact->map, array('class' => 'form-control', 'placeholder' => __('Enter map'), 'required' => 'required'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\markup\resources\views/contact/edit.blade.php ENDPATH**/ ?>