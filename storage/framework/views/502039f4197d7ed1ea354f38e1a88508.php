                        ...
                        <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-lg-4 col-md-6 col-sm-12 col-12 mb-40">
                                <div class="item-box radius-15 md-mb30">
                                    ...
                                    <p><?php echo e(substr($item->detail,0,100)); ?> ...</p>
                                    <a href="<?php echo e(route(app()->getLocale().'.service_single',$item->slug)); ?>" class="rmore mt-30">
...
<?php echo $__env->make('front.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\markup\resources\views/front/pages/services.blade.php ENDPATH**/ ?>