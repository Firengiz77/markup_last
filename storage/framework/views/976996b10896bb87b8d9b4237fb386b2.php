...
<?php $__env->startSection('action-btn'); ?>
    <a href="<?php echo e(route('project.create')); ?>" class="btn btn-sm btn-icon  btn-primary me-2 text-white"  data-title="<?php echo e(__('Create New Project')); ?>"  data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Create')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\markup\resources\views/project/index.blade.php ENDPATH**/ ?>