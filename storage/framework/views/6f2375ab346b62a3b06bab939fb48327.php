...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('MetaTag')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('title'); ?>
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block text-white font-weight-bold mb-0 "><?php echo e(__('MetaTag')); ?></h5>
    </div>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Home')); ?></a></li>
    <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('MetaTag')); ?></li>
<?php $__env->stopSection(); ?>
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <?php $__currentLoopData = \App\Models\Utility::languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tab-pane fade <?php echo e($loop->first?"active show":""); ?>" id="pills-<?php echo e($code); ?>" role="tabpanel"
                        ...
                        <?php echo e(Form::model($metatag, array('route' => array('metatag.update', $metatag->id), 'method' => 'PUT','enctype'=>'multipart/form-data'))); ?>
...
<?php echo e(Form::textarea('meta_title', $metatag->getTranslation('meta_title', $code), array('class' => 'form-control', 'rows'=> 4,'placeholder' => __('Enter meta_title'), 'required' => 'required'))); ?>
...
<?php echo e(Form::textarea('meta_description', $metatag->getTranslation('meta_description', $code), array('class' => 'form-control',  'rows'=> 4,'placeholder' => __('Enter meta_description'), 'required' => 'required'))); ?>
...
<?php echo e(Form::textarea('meta_keywords', $metatag->getTranslation('meta_keywords', $code), array('class' => 'form-control',  'rows'=> 4,'placeholder' => __('Enter meta_keywords'), 'required' => 'required'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\markup\resources\views/metatag/edit.blade.php ENDPATH**/ ?>