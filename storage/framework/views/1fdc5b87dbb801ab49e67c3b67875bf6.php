            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <?php $__currentLoopData = \App\Models\Utility::languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tab-pane fade <?php echo e($loop->first?"active show":""); ?>" id="pills-<?php echo e($code); ?>" role="tabpanel"
                        ...
                        <?php echo e(Form::model($projectimage, array('route' => array('projectimage.update', $projectimage->id), 'method' => 'PUT','enctype'=>'multipart/form-data'))); ?>
...
<?php echo e(Form::label('project_id', __('project_id'), array('class' => 'form-label'))); ?>

<?php echo e(Form::text('project_id', $projectimage->project_id, array('class' => 'form-control', 'placeholder' => __('Enter project_id'), 'required' => 'required'))); ?>
...
<img src='/public/<?php echo e($projectimage->image); ?>' width='200' class='mt-2'/>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bcg\resources\views/projectimage/edit.blade.php ENDPATH**/ ?>