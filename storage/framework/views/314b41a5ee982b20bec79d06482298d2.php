<?php ($store_logo=\App\Models\Utility::get_file('uploads/product_cover_image/')); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <?php echo e(Form::open(array('url'=>'admin/product','method'=>'post','enctype'=>'multipart/form-data'))); ?>
...
<div class='col-12'><div class='form-group'><?php echo e(Form::label('slug', __('slug'), array('class' => 'form-label'))); ?><?php echo e(Form::text('slug', null, array('class' => 'form-control', 'placeholder' => __('Enter slug'), 'required' => 'required'))); ?></div></div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\markup\resources\views/product/create.blade.php ENDPATH**/ ?>