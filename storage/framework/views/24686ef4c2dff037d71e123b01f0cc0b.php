...
<div class="row">
<div class='col-6'><div class='form-group'><?php echo e(Form::label('category_id', __('Category'), array('class' => 'form-label'))); ?><?php echo e(Form::select('category_id', $categories,null, array('class' => 'form-control', 'placeholder' => __('Enter category'), 'required' => 'required'))); ?></div></div>
<div class='col-6'><div class='form-group'><?php echo e(Form::label('title', __('title'), array('class' => 'form-label'))); ?><?php echo e(Form::text('title', null, array('class' => 'form-control', 'placeholder' => __('Enter title'), 'required' => 'required'))); ?></div></div>
</div>
  ...
  <div class="form-group col-md-12">
                                <div class="custom-fields" data-value="">
                                    ...
                                    <div class="card-body table-border-style" style="padding:10px 0px !important">
                                            <?php echo csrf_field(); ?>
                                            <div class="table-responsive m-0 custom-field-table" style="width:100% !important">
...
<div class='form-group'>
    <input type='file' multiple name='images[]' id='blog_cover_image' class='form-control' onchange='document.getElementById("imagesImg").src = window.URL.createObjectURL(this.files[0])'><img id='imagesImg' src='' width='20%' class='mt-2'/>
</div>
</div>
...
<div class='col-12'><div class='form-group'><?php echo e(Form::label('meta_title', __('meta_title'), array('class' => 'form-label'))); ?><?php echo e(Form::textarea('meta_title', null, array('class' => 'form-control', 'rows' => 3,'placeholder' => __('Enter meta_title'), 'required' => 'required'))); ?></div></div>
<div class='col-12'><div class='form-group'><?php echo e(Form::label('meta_description', __('meta_description'), array('class' => 'form-label'))); ?><?php echo e(Form::textarea('meta_description', null, array('class' => 'form-control','rows' => 3, 'placeholder' => __('Enter meta_description'), 'required' => 'required'))); ?></div></div>
<div class='col-12'><div class='form-group'><?php echo e(Form::label('meta_keywords', __('meta_keywords'), array('class' => 'form-label'))); ?><?php echo e(Form::textarea('meta_keywords', null, array('class' => 'form-control','rows' => 3, 'placeholder' => __('Enter meta_keywords'), 'required' => 'required'))); ?></div></div>
</div>
</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\markup\resources\views/project/create.blade.php ENDPATH**/ ?>