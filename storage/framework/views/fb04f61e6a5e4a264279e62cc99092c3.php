            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <?php $__currentLoopData = \App\Models\Utility::languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tab-pane fade <?php echo e($loop->first?"active show":""); ?>" id="pills-<?php echo e($code); ?>" role="tabpanel"
                        ...
                        <?php echo e(Form::model($project, array('route' => array('project.update', $project->id), 'method' => 'PUT','enctype'=>'multipart/form-data'))); ?>
...
<?php echo e(Form::text('country', $project->getTranslation('country', $code), array('class' => 'form-control', 'placeholder' => __('Enter country'), 'required' => 'required'))); ?>
...
<?php echo e(Form::text('title', $project->getTranslation('title', $code), array('class' => 'form-control', 'placeholder' => __('Enter title'), 'required' => 'required'))); ?>
...
<?php echo e(Form::text('status', $project->getTranslation('status', $code), array('class' => 'form-control', 'placeholder' => __('Enter status'), 'required' => 'required'))); ?>
...
<?php echo e(Form::textarea('desc', $project->getTranslation('desc', $code), array('class' => 'form-control  summernote-simple nicEdit', 'placeholder' => __('Enter desc'), 'required' => 'required'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bcg\resources\views/project/edit.blade.php ENDPATH**/ ?>