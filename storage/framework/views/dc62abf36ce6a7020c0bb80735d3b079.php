                ...
                <div class="col-md-6">
                  <div class="item-box2 mb-30">
                    <div class="icon mb-40">
                      <img src="/public/<?php echo e(asset($item->image)); ?>" alt="" />
                    </div>
                    <h5 class="mb-15"><?php echo e($item->title); ?></h5>
                    <p>
                     <?php echo e(substr($item->detail,0,40)); ?> ...
                    </p>
                    <a href="<?php echo e(route(app()->getLocale().'.service_single',$item->slug)); ?>" class="rmore">
                      <div class="arrow">
                        <img
                ...
                <div class="col-12">
                  ...
                  >
                    ...
                    >
                      ...
                      <?php echo e(dd($item->getCategory)); ?>
                        ...
                        <div class="swiper-slide">
                          <div class="item">
                            <div class="img">
                              ...
                              <div class="cont">
                                <span class="mb-5"><?php echo e($item->getCategory->name); ?></span>
                                <h6 class="fz-18"><?php echo e($item->title); ?></h6>
                              </div>
                              <a href="<?php echo e(route(app()->getLocale().'.project_single',$item->slug)); ?>" class="<?php echo e($item->title); ?>"></a>
                            </div>
                          </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-lg-11">
                  ...
                  >
                    ...
                    >
                      ...
                      <?php $__currentLoopData = $reference; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="swiper-slide">
                          <div class="item">
                            <div class="img icon-img-100">
                              <a href="<?php echo e($item->link); ?>">
                                <img src="/public/<?php echo e($item->image); ?>" alt="<?php echo e($item->name); ?>" />
                              </a>
                            </div>
                          </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\markup\resources\views/front/pages/index.blade.php ENDPATH**/ ?>