...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <?php echo e(Form::open(array('url'=>'admin/equipment','method'=>'post','enctype'=>'multipart/form-data'))); ?>
                ...
                <div class="card-body table-border-style">
                    ...
                    <div class="row">
                        ...
                        <div class='col-12'><div class='form-group'><?php echo e(Form::label('title', __('Short title'), array('class' => 'form-label'))); ?><?php echo e(Form::text('title', null, array('class' => 'form-control', 'placeholder' => __('Enter short title'), 'required' => 'required'))); ?></div></div>
<div class='col-12'><div class='form-group'><?php echo e(Form::label('code', __('code'), array('class' => 'form-label'))); ?><?php echo e(Form::text('code', null, array('class' => 'form-control', 'placeholder' => __('Enter code'), 'required' => 'required'))); ?></div></div>
<div class='col-12'><div class='form-group'><?php echo e(Form::label('desc', __('desc'), array('class' => 'form-label'))); ?><?php echo e(Form::textarea('desc', null, array('class' => 'form-control', 'placeholder' => __('Enter desc'), 'required' => 'required'))); ?></div></div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bcg\resources\views/equipment/create.blade.php ENDPATH**/ ?>