            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <?php $__currentLoopData = \App\Models\Utility::languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tab-pane fade <?php echo e($loop->first?"active show":""); ?>" id="pills-<?php echo e($code); ?>" role="tabpanel"
                        ...
                        <?php echo e(Form::model($team, array('route' => array('team.update', $team->id), 'method' => 'PUT','enctype'=>'multipart/form-data'))); ?>
...
<?php echo e(Form::text('name', $team->getTranslation('name', $code), array('class' => 'form-control', 'placeholder' => __('Enter name'), 'required' => 'required'))); ?>
...
<div class='col-6'>
<div class='form-group'>
<?php echo e(Form::label('profession', __('profession'), array('class' => 'form-label'))); ?>

<?php echo e(Form::text('profession', $team->getTranslation('profession', $code), array('class' => 'form-control', 'placeholder' => __('Enter profession'), 'required' => 'required'))); ?>
...
<div class='col-4'>
<div class='form-group'>
<?php echo e(Form::label('facebook', __('facebook'), array('class' => 'form-label'))); ?>

<?php echo e(Form::text('facebook', null, array('class' => 'form-control', 'placeholder' => __('Enter facebook'), 'required' => 'required'))); ?>
...
<div class='col-4'>
<div class='form-group'>
<?php echo e(Form::label('linkedin', __('linkedin'), array('class' => 'form-label'))); ?>

<?php echo e(Form::text('linkedin', null, array('class' => 'form-control', 'placeholder' => __('Enter linkedin'), 'required' => 'required'))); ?>
...
<div class='col-4'>
<div class='form-group'>
<?php echo e(Form::label('instagram', __('instagram'), array('class' => 'form-label'))); ?>

<?php echo e(Form::text('instagram', null, array('class' => 'form-control', 'placeholder' => __('Enter instagram'), 'required' => 'required'))); ?>
...
<img src='/public/<?php echo e($team->image); ?>' width='200' class='mt-2'/>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\markup\resources\views/team/edit.blade.php ENDPATH**/ ?>