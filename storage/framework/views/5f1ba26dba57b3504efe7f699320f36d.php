            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <?php $__currentLoopData = \App\Models\Utility::languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tab-pane fade <?php echo e($loop->first?"active show":""); ?>" id="pills-<?php echo e($code); ?>" role="tabpanel"
                        ...
                        <?php echo e(Form::model($projectcategory, array('route' => array('projectcategory.update', $projectcategory->id), 'method' => 'PUT','enctype'=>'multipart/form-data'))); ?>
...
<?php echo e(Form::text('name', $projectcategory->getTranslation('name', $code), array('class' => 'form-control', 'placeholder' => __('Enter name'), 'required' => 'required'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\markup\resources\views/projectcategory/edit.blade.php ENDPATH**/ ?>