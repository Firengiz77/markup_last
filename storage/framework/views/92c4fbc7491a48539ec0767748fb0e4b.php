                    ...
                    <div class="navbar-content">
                        <ul class="dash-navbar">
                            <?php if(Auth::user()->type == 1): ?>
                                ...
                                <li
                                    class="dash-item dash-hasmenu <?php echo e(Request::route()->getName() == 'equipment.index' || request()->is('admin/equipment*') ? ' active dash-trigger' : 'collapsed'); ?>">
                                    <a href="<?php echo e(route('equipment.index')); ?>"
                                       class="dash-link <?php echo e(request()->is('equipment') ? 'active' : ''); ?>">
                                <span class="dash-micon">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-news"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M16 6h3a1 1 0 0 1 1 1v11a2 2 0 0 1 -4 0v-13a1 1 0 0 0 -1 -1h-10a1 1 0 0 0 -1 1v12a3 3 0 0 0 3 3h11" /><path d="M8 8l4 0" /><path d="M8 12l4 0" /><path d="M8 16l4 0" /></svg>
                                </span>
                                        <span class="dash-mtext"><?php echo e(__('equipment')); ?></span>
                                    </a>
                                </li>
                                ...
                                <li
                                    class="dash-item dash-hasmenu <?php echo e(Request::route()->getName() == 'gallery.index' || request()->is('admin/gallery*') ? ' active dash-trigger' : 'collapsed'); ?>">
                                    <a href="<?php echo e(route('gallery.index')); ?>"
                                       class="dash-link <?php echo e(request()->is('gallery') ? 'active' : ''); ?>">
                                <span class="dash-micon">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-news"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M16 6h3a1 1 0 0 1 1 1v11a2 2 0 0 1 -4 0v-13a1 1 0 0 0 -1 -1h-10a1 1 0 0 0 -1 1v12a3 3 0 0 0 3 3h11" /><path d="M8 8l4 0" /><path d="M8 12l4 0" /><path d="M8 16l4 0" /></svg>
                                </span>
                                ...
                                <li
                                    class="dash-item dash-hasmenu <?php echo e(Request::route()->getName() == 'video.index' || request()->is('admin/video*') ? ' active dash-trigger' : 'collapsed'); ?>">
                                    <a href="<?php echo e(route('video.index')); ?>"
                                       class="dash-link <?php echo e(request()->is('video') ? 'active' : ''); ?>">
                                <span class="dash-micon">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-news"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M16 6h3a1 1 0 0 1 1 1v11a2 2 0 0 1 -4 0v-13a1 1 0 0 0 -1 -1h-10a1 1 0 0 0 -1 1v12a3 3 0 0 0 3 3h11" /><path d="M8 8l4 0" /><path d="M8 12l4 0" /><path d="M8 16l4 0" /></svg>
                                </span>
                                        <span class="dash-mtext"><?php echo e(__('video')); ?></span>
                                    </a>
                                </li>

                                <li
                                    class="dash-item dash-hasmenu <?php echo e(Request::route()->getName() == 'certificate.index' || request()->is('admin/certificate*') ? ' active dash-trigger' : 'collapsed'); ?>">
                                    <a href="<?php echo e(route('certificate.index')); ?>"
                                       class="dash-link <?php echo e(request()->is('certificate') ? 'active' : ''); ?>">
                                <span class="dash-micon">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-news"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M16 6h3a1 1 0 0 1 1 1v11a2 2 0 0 1 -4 0v-13a1 1 0 0 0 -1 -1h-10a1 1 0 0 0 -1 1v12a3 3 0 0 0 3 3h11" /><path d="M8 8l4 0" /><path d="M8 12l4 0" /><path d="M8 16l4 0" /></svg>
                                </span>
                                        <span class="dash-mtext"><?php echo e(__('certificate')); ?></span>
                                    </a>
                                </li>
...
<?php /**PATH C:\xampp\htdocs\bcg\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>