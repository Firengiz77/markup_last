                ...
                <div class="navbar-wrapper">
                        ...
                        <ul class="dash-navbar">
                            ...
                            <span class="dash-micon">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>
                                    ...
                                    <li
                                    class="dash-item dash-hasmenu {{ Request::route()->getName() == 'about.edit' || request()->is('admin/about*') ? ' active dash-trigger' : 'collapsed' }}">
                                    <a href="{{ route('about.edit',1) }}"
                                       class="dash-link {{ request()->is('about') ? 'active' : '' }}">
                                <span class="dash-micon">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-news"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M16 6h3a1 1 0 0 1 1 1v11a2 2 0 0 1 -4 0v-13a1 1 0 0 0 -1 -1h-10a1 1 0 0 0 -1 1v12a3 3 0 0 0 3 3h11" /><path d="M8 8l4 0" /><path d="M8 12l4 0" /><path d="M8 16l4 0" /></svg>
                                </span>
                                        <span class="dash-mtext">{{ __('Who We Are') }}</span>
                                    </a>
                                </li>
                                ...
                                <li
                                    class="dash-item dash-hasmenu {{ Request::route()->getName() == 'reference.index' || request()->is('admin/reference*') ? ' active dash-trigger' : 'collapsed' }}">
                                    <a href="{{ route('reference.index') }}"
                                       class="dash-link {{ request()->is('reference') ? 'active' : '' }}">
                                <span class="dash-micon">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-news"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M16 6h3a1 1 0 0 1 1 1v11a2 2 0 0 1 -4 0v-13a1 1 0 0 0 -1 -1h-10a1 1 0 0 0 -1 1v12a3 3 0 0 0 3 3h11" /><path d="M8 8l4 0" /><path d="M8 12l4 0" /><path d="M8 16l4 0" /></svg>
                                </span>
                                        <span class="dash-mtext">{{ __('References') }}</span>
                                    </a>
                                </li>

                                <li
                                    class="dash-item dash-hasmenu {{ Request::route()->getName() == 'team.index' || request()->is('admin/team*') ? ' active dash-trigger' : 'collapsed' }}">
                                    <a href="{{ route('team.index') }}"
                                       class="dash-link {{ request()->is('team') ? 'active' : '' }}">
                                <span class="dash-micon">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-news"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M16 6h3a1 1 0 0 1 1 1v11a2 2 0 0 1 -4 0v-13a1 1 0 0 0 -1 -1h-10a1 1 0 0 0 -1 1v12a3 3 0 0 0 3 3h11" /><path d="M8 8l4 0" /><path d="M8 12l4 0" /><path d="M8 16l4 0" /></svg>
                                </span>
                    ...
                    <li class="dash-item dash-hasmenu collapsed dash-trigger">
                            ...
                            <span class="dash-micon">
                                ...
                                <li
                                    class="dash-item dash-hasmenu {{ Request::route()->getName() == 'projectcategory.index' || request()->is('admin/projectcategory*') ? ' active dash-trigger' : 'collapsed' }}">
                                    <a href="{{ route('projectcategory.index') }}"
                                       class="dash-link {{ request()->is('projectcategory') ? 'active' : '' }}">
                                <span class="dash-micon">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-news"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M16 6h3a1 1 0 0 1 1 1v11a2 2 0 0 1 -4 0v-13a1 1 0 0 0 -1 -1h-10a1 1 0 0 0 -1 1v12a3 3 0 0 0 3 3h11" /><path d="M8 8l4 0" /><path d="M8 12l4 0" /><path d="M8 16l4 0" /></svg>
                                </span>
                                ...
                                <li
                                    class="dash-item dash-hasmenu {{ Request::route()->getName() == 'contact.edit' || request()->is('admin/contact*') ? ' active dash-trigger' : 'collapsed' }}">
                                ...
                                <li
                                    class="dash-item dash-hasmenu {{ Request::route()->getName() == 'maininformation.edit' || request()->is('admin/maininformation*') ? ' active dash-trigger' : 'collapsed' }}">
                                    <a href="{{ route('maininformation.edit',1) }}"
                                ...
                                <li
                                    class="dash-item dash-hasmenu {{ Request::route()->getName() == 'metatag.index' || request()->is('admin/metatag*') ? ' active dash-trigger' : 'collapsed' }}">
                                    <a href="{{ route('metatag.index') }}"
                                       class="dash-link {{ request()->is('metatag') ? 'active' : '' }}">
                                <span class="dash-micon">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-news"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M16 6h3a1 1 0 0 1 1 1v11a2 2 0 0 1 -4 0v-13a1 1 0 0 0 -1 -1h-10a1 1 0 0 0 -1 1v12a3 3 0 0 0 3 3h11" /><path d="M8 8l4 0" /><path d="M8 12l4 0" /><path d="M8 16l4 0" /></svg>
                                </span>
                                        <span class="dash-mtext">{{ __('Meta tags') }}</span>
                                    </a>
                                </li>
