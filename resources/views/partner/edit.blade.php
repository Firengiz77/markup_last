            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                @foreach (\App\Models\Utility::languages() as $code => $lang)
                    <div class="tab-pane fade {{$loop->first?"active show":""}}" id="pills-{{$code}}" role="tabpanel"
                        ...
                        {{Form::model($partner, array('route' => array('partner.update', $partner->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
...
{{ Form::text('title', $partner->getTranslation('title', $code), array('class' => 'form-control', 'placeholder' => __('Enter title'), 'required' => 'required')) }}
</div>
</div>
...
{{ Form::text('link', $partner->link, array('class' => 'form-control', 'placeholder' => __('Enter link'), 'required' => 'required')) }}
</div>
</div>
...
<img src='/public/{{$partner->image}}' width='200' class='mt-2'/>
