            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                @foreach (\App\Models\Utility::languages() as $code => $lang)
                    <div class="tab-pane fade {{$loop->first?"active show":""}}" id="pills-{{$code}}" role="tabpanel"
                        ...
                        {{Form::model($team, array('route' => array('team.update', $team->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
...
{{ Form::text('name', $team->getTranslation('name', $code), array('class' => 'form-control', 'placeholder' => __('Enter name'), 'required' => 'required')) }}
</div>
</div>
...
{{ Form::text('profession', $team->getTranslation('profession', $code), array('class' => 'form-control', 'placeholder' => __('Enter profession'), 'required' => 'required')) }}
</div>
</div>
...
<div class='col-4'>
<div class='form-group'>
{{ Form::label('facebook', __('facebook'), array('class' => 'form-label')) }}
{{ Form::text('facebook', null, array('class' => 'form-control', 'placeholder' => __('Enter facebook'), 'required' => 'required')) }}
</div>
</div>
...
<div class='col-4'>
<div class='form-group'>
{{ Form::label('linkedin', __('linkedin'), array('class' => 'form-label')) }}
{{ Form::text('linkedin', null, array('class' => 'form-control', 'placeholder' => __('Enter linkedin'), 'required' => 'required')) }}
</div>
</div>
...
<div class='col-4'>
<div class='form-group'>
{{ Form::label('instagram', __('instagram'), array('class' => 'form-label')) }}
{{ Form::text('instagram', null, array('class' => 'form-control', 'placeholder' => __('Enter instagram'), 'required' => 'required')) }}
</div>
</div>
...
<img src='/public/{{$team->image}}' width='200' class='mt-2'/>
