...
@endpush
@section('action-btn')
    <a href="{{ route('blog.create') }}" class="btn btn-sm btn-icon  btn-primary me-2 text-white"  data-title="{{ __('Create New Blog') }}"  data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Create') }}">
                            ...
                            <tbody>
                                @foreach ($blogs as $blog)
                                    ...
                                    <td>{{ $blog->title}}</td>
                                        ...
                                        <td class="Action">
                                            <div class="d-flex">
                                                <a href="{{ route('blog.edit', $blog->id) }}" class="btn btn-sm btn-icon  bg-light-secondary me-2"  data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Edit') }}">
