...
<head>
    <title>
        {{ \App\Models\Utility::getValByName('title_text') ? \App\Models\Utility::getValByName('title_text') : config('app.name', 'MarkUp') }}
                        ...
                        <div class="navbar-brand">
                            <a href="#">
                                <img src="{{ $logo . $company_logo . '?timestamp=' . time() }}"
                                    alt="{{ config('app.name', 'MarkUp') }}" alt="logo" loading="lazy"
                ...
                <div class="auth-footer">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <span>&copy; {{ date('Y') }}
                                    {{ App\Models\Utility::getValByName('footer_text') ? App\Models\Utility::getValByName('footer_text') : config('app.name', 'MarkUp') }}
                                </span>
                            </div>
                        </div>
                    </div>
