            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                @foreach (\App\Models\Utility::languages() as $code => $lang)
                    <div class="tab-pane fade {{$loop->first?"active show":""}}" id="pills-{{$code}}" role="tabpanel"
                        ...
                        {{Form::model($sociallink, array('route' => array('sociallink.update', $sociallink->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
...
<div class='col-6'>
<div class='form-group'>
{{ Form::label('icon', __('Icon'), array('class' => 'form-label')) }}
{{ Form::text('icon', null, array('class' => 'form-control', 'placeholder' => __('Enter icon'), 'required' => 'required')) }}
</div>
</div>
