...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                {{Form::open(array('url'=>'admin/reference','method'=>'post','enctype'=>'multipart/form-data'))}}
...
<div class='col-6'><div class='form-group'>{{ Form::label('link', __('link'), array('class' => 'form-label')) }}{{ Form::text('link', null, array('class' => 'form-control', 'placeholder' => __('Enter link'), 'required' => 'required')) }}</div></div>
