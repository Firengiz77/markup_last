...
@endpush
@section('action-btn')
    <a href="{{ route('service.create') }}" class="btn btn-sm btn-icon  btn-primary me-2 text-white"  data-title="{{ __('Create New Service') }}"  data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Create') }}">
                            ...
                            <tbody>
                                @foreach ($services as $service)
                                    ...
                                    <td>{{ $service->title }}</td>
                                        ...
                                        <td class="Action">
                                            <div class="d-flex">
                                                <a href="{{ route('service.edit', $service->id) }}" class="btn btn-sm btn-icon  bg-light-secondary me-2"  data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Edit') }}">
