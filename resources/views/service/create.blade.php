    ...
    <div class="row">
        <div class="col-md-12">
           ...
           <div class="card-header">
            ...
            <div class='col-12'><div class='form-group'>{{ Form::label('title', __('title'), array('class' => 'form-label')) }}{{ Form::text('title', null, array('class' => 'form-control', 'placeholder' => __('Enter title'))) }}</div></div>
           <div class='col-12'><div class='form-group'>{{ Form::label('detail', __('detail'), array('class' => 'form-label')) }}{{ Form::textarea('detail', null, array('class' => 'form-control summernote-simple nicEdit', 'placeholder' => __('Enter detail'), 'required' => 'required')) }}</div></div>
