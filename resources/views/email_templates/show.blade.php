    ...
    <ul class="list-unstyled mb-0 m-2">
        <li class="dropdown dash-h-item drp-language">
            <a class="dash-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown"
                ...
                <span
                    class="drp-text hide-mob text-primary">{{ __('Locale: ') }}{{ ucFirst($LangName->fullName) }}</span>
                ...
                <div class="card-body ">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12">
                            ...
                            {{ Form::textarea('content', $currEmailTempLang->content, ['class' => 'summernote-simple nicEdit', 'required' => 'required']) }}
                        </div>
...
{{--    @livewire('image-upload-link', ['emailTemplate' => $emailTemplate]--}}
    <livewire:image-upload-link :emailTemplate="$emailTemplate">
